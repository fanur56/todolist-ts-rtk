import {tasksActions, tasksReducer, TasksStateType, taskThunks} from './tasks-reducer'
...
test('correct task should be added to correct array', () => {
    ...
    const action = taskThunks.addTaskTC.fulfilled({
        task: {
...
test('status of specified task should be changed', () => {
    const action = taskThunks.updateTaskTC.fulfilled({
        taskId: "2",
...
test('tasks should be added for todolist', () => {
    const action = taskThunks.fetchTasksTC.fulfilled({
